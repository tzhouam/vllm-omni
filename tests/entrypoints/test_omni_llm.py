...
def test_initialize_stage_configs_called_when_none(monkeypatch, fake_stage_config):
    ...
    monkeypatch.setattr(omni_llm_module, "OmniStage", lambda cfg, **kwargs: _FakeStage(cfg, **kwargs))
...
def test_wait_for_stages_ready_timeout(monkeypatch, fake_stage_config):
    ...
    monkeypatch.setattr(omni_llm_module, "load_stage_configs_from_model", _fake_loader)
    monkeypatch.setattr(omni_llm_module, "OmniStage", lambda cfg, **kwargs: _FakeStageNoReady(cfg, **kwargs))
