...
"""AR-Diffusion DreamZero validation harness — accuracy metrics, artifacts, parity check.

Implements the plan in ``BDE_doc/dreamzero_kv_phase1_profiling_accuracy.md``:
compare the AR-Diffusion KV path (enabled) against the model-local path (disabled) on
